      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="mb-6">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-2">
            Hi Mercy, Ready to save a life today?
          </h1>
        </div>
        ...
        <Card className="bg-gradient-to-r from-green-50 to-green-100 border-none">
          <CardContent className="p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <Button className="bg-blood-red hover:bg-blood-red/90 text-white w-full sm:w-auto">
                Schedule Now
              </Button>
            </div>
          </CardContent>
        ...
        {/* Health & Safety Tips */}
        <div>
          <h2 className="text-lg sm:text-xl font-bold text-foreground mb-4">Health & Safety Tips</h2>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center text-lg sm:text-xl">My Donation History</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center text-lg sm:text-xl">Blood Requests Near You</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
